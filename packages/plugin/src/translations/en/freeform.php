...
return [
    ...
    'Please check the <a href="{{ extra.url }}">error log</a> to see if there are any serious issues.' => 'Please check the <a href="{{ extra.url }}">error log</a> to see if there are any serious issues.',
    'Regular' => 'Regular',
    'No modules are installed.' => 'No modules are installed.',
    'forms' => 'forms',
    'form' => 'form',
    '{{ value != 1 ? "forms" : "form" }}' => '{{ value != 1 ? "forms" : "form" }}',
    '{{ value == 1 ? "Enabled" : "Disabled" }}' => '{{ value == 1 ? "Enabled" : "Disabled" }}',
    '{{ value ? "Enabled" : "Disabled" }}' => '{{ value ? "Enabled" : "Disabled" }}',
    '{{ value.enabled ? "Enabled" : "Disabled" }}' => '{{ value.enabled ? "Enabled" : "Disabled" }}',
    '{{ value ? "Enabled" : "Not found" }}' => '{{ value ? "Enabled" : "Not found" }}',
    '{{ value ? value : "Not set" }}' => '{{ value ? value : "Not set" }}',
    '{{ value ? value~" errors found" : "None found" }}' => '{{ value ? value~" errors found" : "None found" }}',
    '{{ value.enabled ? "Enabled, "~value.interval~" days" : "Disabled" }}' => '{{ value.enabled ? "Enabled, "~value.interval~" days" : "Disabled" }}',
    '{{ value.enabled ? "Enabled, "~value.interval~" hours" : "Disabled" }}' => '{{ value.enabled ? "Enabled, "~value.interval~" hours" : "Disabled" }}',
    '{{ value.enabled ? "Enabled, "~value.interval~" seconds" : "Disabled"  }}' => '{{ value.enabled ? "Enabled, "~value.interval~" seconds" : "Disabled"  }}',
    '{{ value.enabled ? "Enabled, "~value.interval~" minutes" : "Disabled"  }}' => '{{ value.enabled ? "Enabled, "~value.interval~" minutes" : "Disabled"  }}',
    '{% if value.count != 0 %}{{ value.count }} per {{ value.interval == "m" ? "minute" : "second"  }}{% else %}Unlimited{% endif %}' => '{% if value.count != 0 %}{{ value.count }} per {{ value.interval == "m" ? "minute" : "second"  }}{% else %}Unlimited{% endif %}',
