...
return [
    ...
    'Integration Logging Level' => 'Integration Logging Level',
    "Set the logging level for integrations as desired. 'Errors' logs only errors, 'Info' logs information about which integrations processed which mapped objects, and 'Debug' logs all processes occurring within integrations, which is useful for setup and debugging." => "Set the logging level for integrations as desired. 'Errors' logs only errors, 'Info' logs information about which integrations processed which mapped objects, and 'Debug' logs all processes occurring within integrations, which is useful for setup and debugging.",
