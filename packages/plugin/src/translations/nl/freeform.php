...
return [
    ...
    'Integration Logging Level' => 'Integratie-logniveau',
    "Set the logging level for integrations as desired. 'Errors' logs only errors, 'Info' logs information about which integrations processed which mapped objects, and 'Debug' logs all processes occurring within integrations, which is useful for setup and debugging." => "Stel het logniveau voor integraties in zoals gewenst. 'Fouten' logt alleen fouten, 'Info' logt informatie over welke integraties welke toegewezen objecten hebben verwerkt, en 'Debug' logt alle processen die binnen integraties plaatsvinden, wat nuttig is voor installatie en foutopsporing.",
